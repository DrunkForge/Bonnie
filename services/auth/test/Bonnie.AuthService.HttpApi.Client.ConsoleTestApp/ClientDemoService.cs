...
using Bonnie.AuthService.Samples;
...
public class ClientDemoService : ITransientDependency
{
	...
	private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
	{
		...
		using (var httpClient = new HttpClient())
		{
			...
			var url = _configuration["RemoteServices:AuthService:BaseUrl"] +
					  "api/AuthService/sample/authorized";
     ...
     * https://authserver4.readthedocs.io/en/latest/quickstarts/2_resource_owner_passwords.html
     */
